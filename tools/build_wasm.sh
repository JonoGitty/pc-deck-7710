...
clang --target=wasm32 -nostdlib -O2 -std=c99 -Wall -Wextra -Werror \
  ...
  -o preview/deck.wasm \
  core/compat.c core/fb.c core/font.c core/out.c core/screens/spectrum.c core/screens/mirror.c core/screens/scope.c core/screens/city.c core/screens/waterfall.c core/screens/vu.c core/screens/spectrum3d.c core/trig.c preview/api.c
